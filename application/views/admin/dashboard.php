                        ...
                        <a href="<?php echo base_url() ?>admin/question-manage">
                            <div class="edu_color_boxes box_right">
                                ...
                                <div class="edu_dash_info">
                                    <ul>
                                        <li>
                                            <p><?php echo html_escape($this->common->languageTranslator('ltr_vimp')); ?> <span><?php echo html_escape($dashboard_count['vimp_question']); ?></span></p>
                                        </li>
                                        <li>
                                            <p><?php echo html_escape($this->common->languageTranslator('ltr_imp')); ?> <span><?php echo html_escape($dashboard_count['imp_question']); ?></span></p>
                                        </li>
                                        <ul>
                                </div>
                            </div>

    			...
    			<?php if($role == '1'){  ?>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                     ...
                     <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12"> 
                        ...
                        <div class="edu_color_boxes box_other">
                            <div class="edu_dash_box_data">
                                <p><?php echo html_escape($this->common->languageTranslator('ltr_revanue'));?></p>
                                <h3><?php if(!empty($Amount)){echo $currSin[7]['velue_text']." ". $Amount;}else{echo $currSin[7]['velue_text']." ". 0;}?></h3>
                            </div>
                            <div class="edu_dash_box_icon">
                                <!--<svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><g><path d="m424 0h-286c-36.393 0-66 29.607-66 66v374c0 39.701 32.299 72 72 72h280c8.837 0 16-7.164 16-16s-7.163-16-16-16h-280c-22.056 0-40-17.944-40-40s17.944-40 40-40h280c8.837 0 16-7.164 16-16v-368c0-8.836-7.163-16-16-16zm-320 371.431v-305.431c0-18.778 15.222-34 34-34h1c2.761 0 5 2.239 5 5v326.164c0 2.615-2.013 4.816-4.622 4.983-10.085.643-19.611 3.373-28.152 7.76-3.303 1.696-7.226-.764-7.226-4.476z"/><path d="m424 424h-280c-8.837 0-16 7.164-16 16s7.163 16 16 16h280c8.837 0 16-7.164 16-16s-7.163-16-16-16z"/></g></svg>-->
                                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><style>.cls-1{fill:#4267C8;}</style></defs><title>01</title><path class="cls-1" d="M8,4.5h8l1.73-1.38a1.73,1.73,0,0,0,.56-1.95A1.73,1.73,0,0,0,16.65,0H7.35A1.73,1.73,0,0,0,5.7,1.17a1.73,1.73,0,0,0,.56,2Z"/><path class="cls-1" d="M16.15,6H7.86A17.34,17.34,0,0,0,3,17.25C3,20.61,4.78,24,8.75,24H15.5c3.39,0,5.5-2.59,5.5-6.75A17.38,17.38,0,0,0,16.15,6Zm-4.53,8.25h.76a2.12,2.12,0,0,1,.37,4.21v.79a.75.75,0,0,1-1.5,0V18.5h-1a.75.75,0,0,1,0-1.5h2.13a.63.63,0,0,0,0-1.25h-.76a2.12,2.12,0,0,1-.37-4.21v-.79a.75.75,0,0,1,1.5,0v.75h1a.75.75,0,0,1,0,1.5H11.62a.63.63,0,0,0,0,1.25Z"/></svg>
                            </div>
                            <div class="edu_dash_info">
                                <ul>
                                    <li><p><?php echo html_escape($this->common->languageTranslator('ltr_offline'));?> <span><?php if(isset($offline)){echo $offline;}else{echo 0;} ?></span></p></li>
                                    <li><p><?php echo html_escape($this->common->languageTranslator('ltr_online'));?> <span><?php if(isset($online)){echo $online;}else{echo 0;} ?></span></p></li>
                                <ul>
                            </div>
                        </div>
                        </a>

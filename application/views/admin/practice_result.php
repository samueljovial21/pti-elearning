		...
		?>
    		...
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
				    ...
				    <button class="multiDelete btn_delete btn btn-primary" data-placement="top" title="Delete" data-table="practice_result" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?></button>
				    <?php }?>
        		</div>
					</div>
        		</div>

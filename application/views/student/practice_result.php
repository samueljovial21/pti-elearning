<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_practice_manager">
	    <?php 
	    if(!empty($paperList) && !empty($papeResult)){
	    ?>
		<div class="edu_admin_informationdiv sectionHolder">
	        ...
	        <div class="edu_main_wrapper edu_table_wrapper">
    	       <div class="tableFullWrapper">
                    <table class="server_datatable datatable table table-striped table-hover dt-responsive" cellspacing="0" width="100%" data-url="front_ajax/result_table/practice">
                        <thead>
                            <tr> 
                                <th>#</th>

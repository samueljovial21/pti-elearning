                                        ...
                                        <div class="edu_color_boxes box_left">
                                            ...
                                            <div class="edu_dash_info">
                                                <ul>
                                                    ...
                                                    ?>
                                                        <li>
                                                            <p><a href="#" class="courses_atc enrollNowSubmit" data-id="<?= $value['id']; ?>" data-email="<?= $this->session->userdata('email') ?>" data-name="<?= $this->session->userdata('name') ?>" data-mobile="<?= $this->session->userdata('contact_no') ?>"> <?php echo html_escape($this->common->languageTranslator('ltr_enroll_now')); ?> </a></p>
                                                        </li>

                                                    <?php } else { ?>

                                                        <li>
                                                            <p><a href="#" class=""> <?php echo html_escape($this->common->languageTranslator('ltr_already_enrolled')); ?> </a></p>
                                                        </li>
                                                    <?php } ?>
                                                    <ul>
                                            </div>

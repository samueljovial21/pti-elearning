                ...
                <ul>
                    <li <?php echo in_array("dashboard",$cur_arr)?'class="active"':'';?>><a href="<?php echo base_url()?>admin/dashboard">
                        ...
                        <?php if($this->session->userdata['super_admin']==1){ ?>
                            ...
                            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.17 14.16"><defs><style>.cls-1{fill:#4267C8;}</style></defs><title>Search results for Multiple users - Flaticon-2</title><path class="cls-1" d="M3.45,5a1.94,1.94,0,0,0,1.43-.6,2,2,0,0,0,.59-1.43,2,2,0,0,0-.59-1.43A2,2,0,0,0,3.45.92,2,2,0,0,0,2,1.51a2,2,0,0,0-.59,1.43A1.92,1.92,0,0,0,2,4.37,1.93,1.93,0,0,0,3.45,5Z" transform="translate(-0.42 -0.92)"/><path class="cls-1" d="M5.85,8.12A2.91,2.91,0,0,0,8,9a2.91,2.91,0,0,0,2.15-.89A2.92,2.92,0,0,0,11,6a3,3,0,0,0-3-3A3,3,0,0,0,5,6,2.91,2.91,0,0,0,5.85,8.12Z" transform="translate(-0.42 -0.92)"/><path class="cls-1" d="M12.55,5A1.93,1.93,0,0,0,14,4.37a1.92,1.92,0,0,0,.59-1.43A2,2,0,0,0,14,1.51a2,2,0,0,0-2.86,0,2,2,0,0,0-.59,1.43,2,2,0,0,0,.59,1.43A1.94,1.94,0,0,0,12.55,5Z" transform="translate(-0.42 -0.92)"/><path class="cls-1" d="M14.6,5a1.46,1.46,0,0,0-.34.16,6,6,0,0,1-.77.34,2.83,2.83,0,0,1-.94.17,3.22,3.22,0,0,1-1.05-.18,3.28,3.28,0,0,1,0,.52,3.46,3.46,0,0,1-.64,2A2.72,2.72,0,0,1,13,9h1.06a1.83,1.83,0,0,0,1.09-.32,1.05,1.05,0,0,0,.44-.93C15.58,5.9,15.26,5,14.6,5Z" transform="translate(-0.42 -0.92)"/><path class="cls-1" d="M13.42,11.35a5.28,5.28,0,0,0-.21-.85,3.72,3.72,0,0,0-.33-.77,3,3,0,0,0-.49-.64,2.13,2.13,0,0,0-.68-.43,2.5,2.5,0,0,0-.88-.15.82.82,0,0,0-.34.17l-.58.37a3.32,3.32,0,0,1-.84.38,3.45,3.45,0,0,1-2.14,0,3.32,3.32,0,0,1-.84-.38l-.58-.37a.82.82,0,0,0-.34-.17,2.5,2.5,0,0,0-.88.15,2,2,0,0,0-.67.43,2.47,2.47,0,0,0-.49.64,3.29,3.29,0,0,0-.34.77,5.28,5.28,0,0,0-.21.85,5.75,5.75,0,0,0-.11.87q0,.39,0,.81A2,2,0,0,0,3,14.53a2.14,2.14,0,0,0,1.54.55h6.9A2.14,2.14,0,0,0,13,14.53a2,2,0,0,0,.57-1.5q0-.42,0-.81A5.75,5.75,0,0,0,13.42,11.35Z" transform="translate(-0.42 -0.92)"/><path class="cls-1" d="M5.1,8a3.46,3.46,0,0,1-.64-2,3.28,3.28,0,0,1,0-.52,3.22,3.22,0,0,1-1,.18,2.88,2.88,0,0,1-.94-.17,6,6,0,0,1-.77-.34A1.46,1.46,0,0,0,1.4,5c-.66,0-1,.93-1,2.79a1.05,1.05,0,0,0,.44.93A1.83,1.83,0,0,0,2,9H3A2.72,2.72,0,0,1,5.1,8Z" transform="translate(-0.42 -0.92)"/></svg>
